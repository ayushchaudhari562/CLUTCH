      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-6 space-y-4">
          ...
          <div className="space-y-6">
            {posts.map((post) => (
              <div key={post.id}  onClick={() => { navigate(`/post/${post.id}`); handlePostClick(post); }} className="bg-[#1c1c1c] rounded-xl p-5 border border-[#2d2d2d] cursor-pointer hover:border-gray-600 transition-colors">
                <div className="flex gap-3 mb-4">
