    ...
    <div className="h-screen bg-[#0a0a0a] text-white p-3 font-sans flex flex-col gap-3 overflow-hidden">
      ...
      <div className="flex justify-between items-center bg-[#141414] px-5 py-3 rounded-xl border border-neutral-800 shadow-sm shrink-0">
        ...
        <div className="flex gap-2">
          <button onClick={toggleAudio} className={`p-2 rounded-lg transition ${isAudioEnabled ? "bg-neutral-800 hover:bg-neutral-700 text-gray-300" : "bg-red-500/20 text-red-500 hover:bg-red-500/30"}`}>
          ...
          <button onClick={toggleVideo} className={`p-2 rounded-lg transition ${isVideoEnabled ? "bg-neutral-800 hover:bg-neutral-700 text-gray-300" : "bg-red-500/20 text-red-500 hover:bg-red-500/30"}`}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
              {isVideoEnabled ? (
